            ...
            <Card className='min-h-screen border_card'>
                <div className="flex items-center justify-end ">
                    <Segmented
                        ...
                        options={[
                            {
                                value: 'List', icon: <Popover content="Watch as table"><List className="w-4 h-4"/>
                                </Popover>
                            },
                            {
                                value: 'Kanban', icon: <Popover content="Watch as images"><LayoutGrid
                                    className="w-4 h-4"/> </Popover>
                            },
                        ]}
                        defaultValue="List"
                        onChange={(e: any) => {
